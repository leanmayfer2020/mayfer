...
/*
ACA ESTABA COMENTADO EL REQUIRE DE UAPARSER Y NO RECUERDO PORQUE - HAY QUE REVISARLO!
*/

const main     = require('../../controllers/MainController');
const api      = require('../../controllers/ApiController');
const admin    = require('../../controllers/AdminController');
const campana    = require('../../controllers/CampanasController');
...
router.get('/admin/precios', (req, res, next) => admin.getListPrice(req, res, next));

router.get('/pedidos', (req, res, next) => pedidos.index(req, res, next));
router.post('/pedidos', (req, res, next) => pedidos.saveOrder(req, res, next));
router.get('/ordenes', (req, res, next) => pedidos.list(req, res, next));

router.get('/admin/carta-email', (req, res, next) => admin.presentationLetterEmailSubmit(req, res, next));
router.post('/admin/carta-email', (req, res, next) => admin.presentationLetter(req, res, next));
router.get('/admin/carta', (req, res, next) => admin.presentationLetterSubmit(req, res, next));
router.post('/admin/carta', (req, res, next) => admin.presentationLetter(req, res, next));

// router.get('/admin/potenciales', (req, res, next) => campana.index(req, res, next));
